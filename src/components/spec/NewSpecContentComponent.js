...
class NewSpecContentComponent extends Component {

  render(){
    const { campaign, medium, adFormat, creative, contentTypes, contentType, onContentTypeChange, contentFormats, contentFormat, onContentFormatChange, handleSubmit, onBack, contents,
      onContentClick, contentTmp, contentView, onSaveSpec } = this.props;
    return (
      <div className='crear'>
        <div className='wrapper'>
          <div className='container'>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type='submit' className='button'>AGREGAR DETALLES <FontAwesomeIcon icon='chevron-right' /></button>
            </form>
          </div>
        </div>
        <SidebarComponent campaign={campaign} medium={medium} adFormat={adFormat} creative={creative} contents={contents}
          contentTmp={contentTmp} onContentClick={onContentClick} contentView={contentView} onSaveSpec={onSaveSpec} />
...
const NewSpecContentForm = reduxForm({ form: 'NewSpecContent', validate })(NewSpecContentComponent);

export default setPropsAsInitial(NewSpecContentForm);